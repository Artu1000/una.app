 ...
 * Generated for Laravel 5.2.21 on 2016-03-08.
 *
...
namespace {
    ...
    class Modal extends \App\Facades\ModalHelperFacade{
         ...
         * @static 
         */
        public static function alert($messages, $type = null, $before_reload = true){
            return \App\Helpers\ModalHelper::alert($messages, $type, $before_reload);
        }
        ...
        public static function confirm($data){
            return \App\Helpers\ModalHelper::confirm($data);
        }
         ...
         * @static 
         */
        public static function formatAlertMessage($messages, $type){
            return \App\Helpers\ModalHelper::formatAlertMessage($messages, $type);
        }
        
    }


    class ImageManager extends \App\Facades\ImageManagerHelperFacade{
         ...
         * @static 
         */
        public static function optimizeAndResize($src_path, $file_name, $extension, $storage_path, $sizes, $remove_src = true){
            return \App\Helpers\ImageManagerHelper::optimizeAndResize($src_path, $file_name, $extension, $storage_path, $sizes, $remove_src);
        }
         ...
         * @static 
         */
        public static function resize($file_name, $extension, $storage_path, $sizes){
            return \App\Helpers\ImageManagerHelper::resize($file_name, $extension, $storage_path, $sizes);
        }
         ...
         * @static 
         */
        public static function optimize($src_path, $dest_path, $file_name, $extension){
            return \App\Helpers\ImageManagerHelper::optimize($src_path, $dest_path, $file_name, $extension);
        }
         ...
         * @static 
         */
        public static function optimizeAndRemoveSrc($src_path, $dest_path, $file_name, $extension){
            return \App\Helpers\ImageManagerHelper::optimizeAndRemoveSrc($src_path, $dest_path, $file_name, $extension);
        }
         ...
         * @static 
         */
        public static function remove($file_name, $storage_path, $sizes){
            return \App\Helpers\ImageManagerHelper::remove($file_name, $storage_path, $sizes);
        }
         ...
         * @static 
         */
        public static function imagePath($public_path, $file_name, $key = null, $size = null){
            return \App\Helpers\ImageManagerHelper::imagePath($public_path, $file_name, $key, $size);
        }
        
    }


    class Console extends \App\Facades\ConsoleHelperFacade{
         ...
         * @static 
         */
        public static function execWithOutput($cmd, $console){
            return \App\Helpers\ConsoleHelper::execWithOutput($cmd, $console);
        }
        
    }


    class Permission extends \App\Facades\PermissionHelperFacade{
         ...
         * @static 
         */
        public static function hasPermissionJson($permission){
            return \App\Helpers\PermissionHelper::hasPermissionJson($permission);
        }
        
    }


    class Validation extends \App\Facades\ValidationHelperFacade{
         ...
         * @static 
         */
        public static function check($inputs, $rules, $ajax = false){
            return \App\Helpers\ValidationHelper::check($inputs, $rules, $ajax);
        }
        
    }


    class TableList extends \App\Facades\TableListHelperFacade{
        
        /**
         * 
         *
         * @param \App\Helpers\Builder $query
         ...
         * @static 
         */
        public static function prepare($query, $request, $columns, $routes, $confirm_config = array(), $search_config = array(), $enable_lines_choice = false, $lines_number = null){
            return \App\Helpers\TableListHelper::prepare($query, $request, $columns, $routes, $confirm_config, $search_config, $enable_lines_choice, $lines_number);
        }
        
        /**
         * 
         *
         * @param \App\Helpers\LengthAwarePaginator $paginated_list
         * @return string 
         * @static 
         */
        public static function tableNavStatus($paginated_list){
            return \App\Helpers\TableListHelper::tableNavStatus($paginated_list);
        }
        
    }


    class Entry extends \App\Facades\EntryHelperFacade{
         ...
         * @static 
         */
        public static function sanitizeAll($entries){
            return \App\Helpers\EntryHelper::sanitizeAll($entries);
        }
         ...
         * @static 
         */
        public static function sanitize($entry, $default = null){
            return \App\Helpers\EntryHelper::sanitize($entry, $default);
        }
        
    }


    class CustomLog extends \App\Facades\CustomLogHelperFacade{
        ...
        public static function error($error){
            return \App\Helpers\CustomLogHelper::error($error);
        }
        ...
        public static function httpRequests(){
            return \App\Helpers\CustomLogHelper::httpRequests();
        }
         ...
         * @static 
         */
        public static function sqlRequests(){
            return \App\Helpers\CustomLogHelper::sqlRequests();
        }
