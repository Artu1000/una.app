                ...
                <form role="form" method="POST" action="
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_lastname" class="form-control capitalize" type="text" name="last_name" value="{{ old('last_name') ? old('last_name') : $user->last_name }}" placeholder="{{ trans('users.view.label.last_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_firstname" class="form-control capitalize-first-letter" type="text" name="first_name" value="{{ old('first_name') ? old('first_name') : $user->first_name }}" placeholder="{{ trans('users.view.label.first_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_birth_date" type='text' class="form-control datepicker" name="birth_date" value="{{ old('birth_date') ? old('birth_date') : $user->birth_date }}" placeholder="{{ trans('users.view.label.birth_date') }}">
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_phone_number" class="form-control" type="tel" name="phone_number" value="{{ old('phone_number') ? old('phone_number') : $user->phone_number }}" placeholder="{{ trans('users.view.label.phone_number') }}">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_email" class="form-control" type="email" name="email" value="{{ old('email') ? old('email') : $user->email }}" placeholder="{{ trans('users.view.label.email') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_address" class="form-control" type="text" name="address" value="{{ old('address') ? old('address') : $user->address }}" placeholder="{{ trans('users.view.label.address') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_zip_code" class="form-control" type="number" name="zip_code" value="{{ old('zip_code') ? old('zip_code') : $user->zip_code }}" placeholder="{{ trans('users.view.label.zip_code') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_city" class="form-control" type="text" name="city" value="{{ old('city') ? old('city') : $user->city }}" placeholder="{{ trans('users.view.label.city') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="input_country" class="form-control" type="text" name="country" value="{{ old('country') ? old('country') : $user->country }}" placeholder="{{ trans('users.view.label.country') }}">
                                </div>
                            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="text-danger"><i class="fa fa-exclamation-triangle"></i> {{ trans('users.view.info.password') }}</p>
