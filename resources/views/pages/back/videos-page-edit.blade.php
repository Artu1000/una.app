        ...
        <div class="text-content">
            ...
            <div class="col-sm-12">
                ...
                <h2>
                    ...
                    {{ trans('videos.page.title.management') }}
                </h2>

                <hr>

                @if(Sentinel::getUser()->hasAccess('videos.page.update'))
                    <form role="form" method="POST" action="{{ route('videos.page_update') }}" enctype="multipart/form-data">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">{{ trans('videos.page.title.content') }}</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input id="input_title" class="form-control capitalize-first-letter" name="title" placeholder="{{ trans('videos.page.label.title') }}" value="{{ old('title') ? old('title') : $title }}">
                                    </div>
                                </div>
                                ...
                                @if($background_image)
                                    <div class="form-group image">
                                        <div class="form-group">
                                            <a class="img-thumbnail" href="{{ ImageManager::imagePath(config('image.videos.public_path'), $background_image, 'background_image', '767') }}" data-lity>
                                                <img src="{{ ImageManager::imagePath(config('image.videos.public_path'), $background_image, 'background_image', 'admin') }}">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <label for="input_description">{{ trans('videos.page.label.description') }}</label>
                                <div class="form-group textarea">
                                    <textarea id="input_description" class="form-control markdown" name="description" placeholder="{{ trans('videos.page.label.description') }}">{{ old('description') ? old('description') : $description }}</textarea>
                                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{ trans('videos.page.title.list') }}</h3>
                    </div>
