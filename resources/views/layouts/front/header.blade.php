        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    <li class="menu_tab">
                        <a href="news.html" title="Actualités">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="menu_tab">
                                <a href="history.html" title="Historique">
                                    <i class="fa fa-university"></i> Historique
                                </a>
                            </li>
                            <li class="menu_tab">
                                <a href="prize-list.html" title="Palmarès">
                                    <i class="fa fa-trophy"></i> Palmarès
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li class="menu_tab">
                                <a href="management-team.html" title="Equipe dirigeante">
                                    <i class="fa fa-cogs"></i> Equipe dirigeante
                                </a>
                            </li>
                            <li class="menu_tab">
                                <a href="status.html" title="Statuts">
                                    <i class="fa fa-compass"></i> Statuts
                                </a>
                            </li>
                            <li class="menu_tab">
                                <a href="regulations.html" title="Règlement intérieur">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li class="menu_tab">
                                <a href="tarifs.html" title="Inscription">
                                    <i class="fa fa-sign-in"></i> Inscription
                                </a>
                            </li>
                            <li class="menu_tab">
                                <a href="schedule.html" title="Horaires">
                                    <i class="fa fa-clock-o"></i> Horaires
                                </a>
                            </li>
                            <li class="divider"></li>
                            <li class="menu_tab">
                                <a href="calendar.html" title="Calendrier">
                                    <i class="fa fa-calendar"></i> Calendrier
                                </a>
                            </li>
                            <li class="menu_tab">
                                <a href="textiles.html" title="Textile">
