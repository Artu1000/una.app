...
return [
    ...
    "page"    => [
        ...
        "label"  => [
            ...
            "photo_album_id"             => "Album photo de l'actualité",
            "photo_album_id_placeholder" => "--- Séléctionnez un album photo ---",
            "video_id"                   => "Vidéo de l'actualité",
            "video_id_placeholder"       => "--- Séléctionnez une vidéo ---",
        ],
    ],
