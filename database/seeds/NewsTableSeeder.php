    ...
    public function run()
    {
        ...
        $news_repo->createMultiple([
            [
                ...
                'content' => "<p>Vous ne savez pas quel sport choisir cette année ?</p>
                                <p>Vous pensez à l'aviron sans n'avoir jamais osé vous lancer ?</p>
                                <p>Le club Université Nantes vous convie à ses portes-ouvertes, l'occasion rêvée de vous essayer gratuitement à notre sport !</p>

                                <h3>C'est quand ?</h3>
                                <p>Nous vous accueillons les samedis 12 septembre, 19 septembre et 10 octobre, de 10h à 17h.</p>

                                <h3>Le programme ?</h3>
                                <p>Des initiations gratuites pour toute la famille (à partir de 10 ans).</p>
                                <p>Un stand restauration (gateaux sucrés et boissons).</p>

                                <h3>L'UNA, c'est quoi ?</h3>
                                ...
                                <p>&nbsp;</p>
                                <p>Et pour toute question, <a href=\"#contact\" title=\"Nous contacter\">contactez-nous !</a></p>
                                <p>A bientôt au club Université Nantes Aviron</p>"
            ],
            [
                'news_category_id' => config('news.categories_keys.club'),
                'title' => "Rentrée 2015 : 3 sessions de portes-ouvertes à l'UNA",
